package com.example.endure.Adapter;
...
import com.example.endure.Activity.WorkoutActivity;
import com.example.endure.Domain.Workout;
import com.example.endure.databinding.ViewholderWorkoutBinding;
...
public class WorkoutAdapter extends RecyclerView.Adapter<WorkoutAdapter.Viewholder> {
    ...
    public void onBindViewHolder(@NonNull WorkoutAdapter.Viewholder holder, int position) {
        ...
        Glide.with(holder.itemView.getContext()).load(resId).into(holder.binding.pic);

        holder.binding.durationTxt.setText(list.get(position).getDurationAll());
        holder.binding.exerciseTxt.setText(list.get(position).getLessons().size()+" Exercise");
